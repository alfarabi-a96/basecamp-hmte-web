...
import { alumniData, formatCurrency, calculateProgress } from '../data/alumniData'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card p-6 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Total Terkumpul</h3>
            ...
            <div className="mb-6">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div 
                  ...
                  style={{ width: `${calculateProgress(year.collected, year.target)}%` }}
                />
              </div>
      ...
      {!isAdmin() && (
        <div className="card p-4 bg-blue-50 border-blue-200">
          <p className="text-sm text-blue-700">
            <strong>Catatan:</strong> Anda masuk sebagai guest. Untuk mengedit data laporan, 
